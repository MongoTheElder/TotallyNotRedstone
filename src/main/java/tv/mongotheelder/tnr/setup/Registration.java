...
import tv.mongotheelder.tnr.buttons.*;
...
public class Registration {
    ...
    // Keypad
    public static final RegistryObject<Keypad> KEYPAD_BLOCK = BLOCKS.register("keypad", () -> new Keypad(Block.Properties.create(Material.IRON).hardnessAndResistance(Keypad.BASE_HARDNESS).sound(SoundType.METAL)));
    ...
    // Buttons
    public static final RegistryObject<LargeTimedButton> LARGE_SQUARE_TIMED_BUTTON_BLOCK = BLOCKS.register("large_timed_button", () -> new LargeTimedButton(Block.Properties.create(Material.ROCK).doesNotBlockMovement().hardnessAndResistance(TimedButton.BASE_HARDNESS).sound(SoundType.STONE)));
    public static final RegistryObject<MediumTimedButton> MEDIUM_SQUARE_TIMED_BUTTON_BLOCK = BLOCKS.register("medium_timed_button", () -> new MediumTimedButton(Block.Properties.create(Material.ROCK).doesNotBlockMovement().hardnessAndResistance(TimedButton.BASE_HARDNESS).sound(SoundType.STONE)));
    public static final RegistryObject<SmallTimedButton> SMALL_SQUARE_TIMED_BUTTON_BLOCK = BLOCKS.register("small_timed_button", () -> new SmallTimedButton(Block.Properties.create(Material.ROCK).doesNotBlockMovement().hardnessAndResistance(TimedButton.BASE_HARDNESS).sound(SoundType.STONE)));
    ...
    // Wireless Receiver
    public static final RegistryObject<WirelessRedstoneReceiver> WIRELESS_REDSTONE_RECEIVER_BLOCK = BLOCKS.register("wireless_redstone_receiver", () -> new WirelessRedstoneReceiver(Block.Properties.create(Material.IRON).hardnessAndResistance(WirelessRedstoneReceiver.BASE_HARDNESS).sound(SoundType.METAL)));
    ...
    private static void generateWirelessRedstoneIndicators() {
        for (SolidColors color : SolidColors.values()) {
            ...
            RegistryObject<WirelessRedstoneIndicator> block = BLOCKS.register("wireless_redstone_indicator_"+colorName, () -> new WirelessRedstoneIndicator(Block.Properties.create(Material.IRON).hardnessAndResistance(WirelessRedstoneIndicator.BASE_HARDNESS).sound(SoundType.METAL)));
