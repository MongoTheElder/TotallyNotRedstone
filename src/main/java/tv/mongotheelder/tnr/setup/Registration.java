...
public class Registration {
    ...
    // Buttons
    public static final RegistryObject<LargeTimedButton> LARGE_SQUARE_TIMED_BUTTON_BLOCK = BLOCKS.register("large_timed_button", () -> new LargeTimedButton(Block.Properties.create(Material.ROCK).doesNotBlockMovement().hardnessAndResistance(0.6f).sound(SoundType.STONE)));
    public static final RegistryObject<MediumTimedButton> MEDIUM_SQUARE_TIMED_BUTTON_BLOCK = BLOCKS.register("medium_timed_button", () -> new MediumTimedButton(Block.Properties.create(Material.ROCK).doesNotBlockMovement().hardnessAndResistance(0.6f).sound(SoundType.STONE)));
    public static final RegistryObject<SmallTimedButton> SMALL_SQUARE_TIMED_BUTTON_BLOCK = BLOCKS.register("small_timed_button", () -> new SmallTimedButton(Block.Properties.create(Material.ROCK).doesNotBlockMovement().hardnessAndResistance(0.6f).sound(SoundType.STONE)));
    ...
    private static void generateWirelessRedstoneIndicators() {
        for (SolidColors color : SolidColors.values()) {
            ...
            RegistryObject<WirelessRedstoneIndicator> block = BLOCKS.register("wireless_redstone_indicator_"+colorName, () -> new WirelessRedstoneIndicator(Block.Properties.create(Material.IRON).hardnessAndResistance(1.2F).sound(SoundType.METAL)));
